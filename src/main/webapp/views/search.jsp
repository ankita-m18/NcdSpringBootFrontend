...
<body class="p-3 m-0 border-0 bd-example">
  ...
  <div class="input-group mb-3">
    ...
    <input name="pk" type="text" class="form-control" aria-label="Sizing example input"
      aria-describedby="inputGroup-sizing-default" pattern="^[A-Za-z0-9\s\.]{1,100}$" title="No special characters allowed other than dot(.)" >
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td scope="col">${ row.getPatientid() }</td>
